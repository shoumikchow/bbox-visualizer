...
img = cv2.imread('test_images/source_multiple_bird.jpg')
annotation = json.load(open('test_images/source_multiple_bird.json'))
...
cv2.imshow("img_with_boxex", img_with_boxes)
cv2.imshow("img_with_T_labels", img_with_T_labels)
cv2.imshow("img_with_flags", img_with_flags)
